<?php get_header(); ?>
<?php 
$thisCat = get_cat_ID('news');
$image_cat = get_term_meta($thisCat, 'id-cat-images', true); ?>

  <div class="main_bg" style="background-image: url(<?php echo get_the_post_thumbnail_url(24, 'full'); ?>)">
    ...
    <section class="news m-t news_page">
      ...
      <div class="wrapper">
        ...
        <div class="container">
          <div class="row">
          	<?php
	          $args = array( 'category_name' => 'news', 'numberposts' => 4);
